...
include 'dbcon.php';    
$result = mysqli_query($conn,"SELECT * FROM games where name='Conor'");
...
if(isset($_POST["BUY"])){
    if(isset($_SESSION['uname'])){
        $_SESSION['cart']["Assassins Cread 3 "] = $price; 
    }
    else{
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="mainbody img-responsive" style="background-image: url('https://ubistatic19-a.akamaihd.net/ubicomstatic/en-us/global/hero/ac3_connorhero_desk_desktop_169398.jpg');">
        ...
        <div style="padding-top:15% ;" class="container-fluid ">
            <div class="row ">
                <div class="col-xs-10 col-md-5 ">
                    <div class="card ">
                        <h1>The Warrior Son</h1>
                        <hr>
                        <p>The untold story of the American Revolution through the eyes of a new Assassin, Connor.</p>
                        <form action="<?php $_PHP_SELF ?>"  method="post">
                        <button class="btn btn-primary btn-block" id="buy" name="BUY" >
                        <h4>Buy now $<?php echo $price;
                            ?></h4>
                        </button>
                        </form>
                    </div>
                ...
                <div class="col-xs-10 col-md-6">
                    <div class="  VideoCard ">
                        <div class="embed-responsive embed-responsive-16by9 ">
                            <iframe width="100% " height="auto " src="https://www.youtube-nocookie.com/embed/-pUhraVG7Ow?controls=0&amp;start=8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
