...
if(isset($_POST['signup'])){
       $username = $_POST["user"];
        ...
        if($result){
            header("Location:http://localhost/17SW109%20lab%2010%20task%201/17SW109%20lab%2010%20task%201/index.php");
        }
        else{
...
<body>
    ...
    <section>
        <form action="<?php $_PHP_SELF ?>" method="POST">
            ...
            <div class="credit">
                <span>
                    <input type="number" placeholder="Credit Card " name="credit" style="border-bottom-left-radius: 6px;" required>
                </span>
                <span>
