...
include 'dbcon.php';    
$result = mysqli_query($conn,"SELECT * FROM games where name='Ezio'");
...
if(isset($_POST["BUY"])){
    ...
    $_SESSION['cart']["Assassins Cread 2 "] = $price; 
    }
    else{
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="mainbody img-responsive" style="background-image: url(media/ezio.jpg);">
            ...
            <div class="row ">
                <div class="col-xs-10 col-md-5 ">
                    <div class="card ">
                        ...
                        <hr>
                        <p>story of family, vengance and conspiracy set in the pristine yet brutal backdrop of a
                            Renaissance Italy.</p>
                ...
                <div class="col-xs-10 col-md-6">
                    <div class="  VideoCard ">
                        <div class="embed-responsive embed-responsive-16by9 ">
                            <iframe width="100% " height="auto " src="https://www.youtube-nocookie.com/embed/_xkCPNECud8?controls=0&amp;start=73" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
